package com.liuwei.android.diffrecycler.processor;
...
class DiffBinding
{
    private final String UTIL_PACKAGE = "com.liuwei.android.diffrecycler.util";

    private final String UTIL_NAME = "MapDiffUtil";

    private ClassName mInterfaceClassName = ClassName.get("com.liuwei.android.diffrecycler.diff", "DiffComparable");
